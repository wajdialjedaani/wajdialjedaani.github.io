...
var Y = (n, o) => () => (o || n((o = { exports: {} }).exports, o), o.exports);
var j = (n, o, l, u) => {
...
var x = (n, o, l) => (
  ...
  j(
    o || !n || !n.__esModule
      ? T(l, "default", { value: n, enumerable: !0 })
      : l,
    n
  )
);
  ...
  (function (n, o) {
      ...
      return (function (e) {
        ...
        ? (function (e) {
            ...
            return {
              ...
              scrollY: function () {
                return e.pageYOffset !== void 0
                  ? e.pageYOffset
                  : (c || a.parentNode || a).scrollTop;
              },
            };
          })(t)
        : (function (e) {
    ...
    function l(t, e, d) {
      ...
      function b() {
        ...
        (i.scrollY = r),
          (i.lastScrollY = m),
          (i.direction = m < r ? "down" : "up"),
          (i.distance = Math.abs(r - m)),
          (i.isOutOfBounds = r < 0 || g < r + h),
          (i.top = r <= e.offset[i.direction]),
          (i.bottom = g <= r + h),
          (i.toleranceExceeded = i.distance > e.tolerance[i.direction]),
          d(i),
          (m = r),
          (p = !1);
      }
      ...
      var y = !!c && { passive: !0, capture: !1 };
      return (
        t.addEventListener("scroll", H, y),
        b(),
        {
          destroy: function () {
